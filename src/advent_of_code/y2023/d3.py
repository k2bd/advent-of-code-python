...
class Engine:
    ...
    def part_numbers(self) -> list[int]:
        result = []
        for _, sym_coord in self.symbols:
            for number, num_coords in self.numbers:
                for neighbor in sym_coord.neighbors():
                    if neighbor in num_coords:
