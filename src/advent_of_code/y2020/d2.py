...
if __name__ == "__main__":
    ...
    print(format_solution(1, lambda: solve(passwords=passwords, validator=is_valid_p1)))
    print(format_solution(2, lambda: solve(passwords=passwords, validator=is_valid_p2)))
